  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="note-actions absolute bottom-3 right-3 flex gap-2">
          <button
            onClick={(e) => {
              e.stopPropagation();
              e.preventDefault();
            ...
            className="p-2.5 rounded-lg bg-ivory-50/95 active:bg-ivory-200 text-charcoal-500 active:text-[#7A3F3B] transition-all shadow-soft touch-manipulation"
            title="Edit note"
          >
          ...
          <button
            ...
            className="p-2.5 rounded-lg bg-ivory-50/95 active:bg-terracotta-100 text-charcoal-500 active:text-terracotta-600 transition-all shadow-soft touch-manipulation"
            title="Delete note"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
